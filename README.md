...
* [Single course (blog)](http://hibbittsdesign.org/demo/grav-course-hub-bootstrap/) or [multiple courses (blogs)](http://hibbittsdesign.org/demo/grav-multi-course-blog-hub/) supported
